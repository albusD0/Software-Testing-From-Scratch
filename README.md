# Описание пройденного курса и моих навыков как тестировщика
---

###  :hammer::muscle: Навыки / инструменты, которыми владею:
- знание типов (видов) тестирования и техник тест-дизайна
- работа с тестовыми артефактами (чек-листы, тест-кейсы) и системами **TMS** (QASE, TestIt, TestLink, Youtrack и др.)
...
<a href="https://stepik.org/certificate/fe656505180b70d949366d3f68fc1e3127ae008c.pdf" target="_blank"><img src="https://github.com/albusD0/albusD0/blob/main/media/stepik-certificate-171826-fe65650_001.png?raw=true" width="480" align="right" /></a>
#### и в ходе которого:
